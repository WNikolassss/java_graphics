...
public class Bird extends JFrame {
    ...
    private void addImageBackground() {
        TextureLoader t = new TextureLoader("source_folder/pipes.jpg", canvas);
    ...
    private TransformGroup getCarGroup() throws IOException {
        Shape3D shape = getModelShape3D("bird", "source_folder/bird/bird.obj");
    ...
    public static void main(String[] args) {
        try {
            ...
            BIrdAnimation carMovement = new BIrdAnimation(car);
